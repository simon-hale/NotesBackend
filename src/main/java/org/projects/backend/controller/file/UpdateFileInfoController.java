...
public class UpdateFileInfoController {
    ...
    JSONObject modifyFileNameById(@RequestParam Map<String, String> data) {
        return updateFileInfoService.modifyFileNameById(data.get("username"), Integer.parseInt(data.get("parentId")), Integer.parseInt(data.get("fileId")), data.get("filenameNew"), data.get("language") == null ? LanguagesSelector.en_US : data.get("language"));
    }
}
