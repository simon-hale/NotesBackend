...
public class DeleteFileInfoController {
    ...
    JSONObject deleteFileById(@RequestParam Map<String, String> data) {
        return deleteFileInfoService.deleteFileById(Integer.valueOf(data.get("id")), data.get("username"), data.get("language") == null ? LanguagesSelector.en_US : data.get("language"));
    }
}
